...
-------------------------------------------------------- 
  ...
  CREATE TABLE Alumno 
   (DNI VARCHAR2(9) PRIMARY KEY,  
	...
	Beca CHAR(1) DEFAULT 'N' CONSTRAINT Beca_es_S_o_N CHECK (Beca IN ('S','N')) 
   ) ;
...
--------------------------------------------------------
  ...
  CREATE TABLE Asignaturas 
   (Cod_Asig VARCHAR2(4) PRIMARY KEY, 
	Nombre VARCHAR2(30), 
	Creditos NUMBER(2,1), 
	Caracter CHAR(2) CONSTRAINT Carácter_es_tr_ob_op_lc CHECK (Caracter IN ('tr','ob','op','lc')),
...
--------------------------------------------------------
  ...
  CREATE TABLE Grupo 
   (Cod_Asig REFERENCES Asignaturas(Cod_Asig), 
	Cod_Grupo NUMBER(2), 
	Tipo VARCHAR2(9) CONSTRAINT Tipo_es_Teoría_o_Prácticas CHECK (Tipo IN ('Teoría','Prácticas')), 
	Max_Al NUMBER(3),
...
--------------------------------------------------------
  ...
  CREATE TABLE Matriculas 
   (Cod_Asig VARCHAR2(4), 
	Cod_Grupo NUMBER(2), 
	Tipo VARCHAR2(9) CONSTRAINT Tipo__es_Teoría_o_Prácticas CHECK (Tipo IN ('Teoría','Prácticas')), 
...
CREATE TABLE Clases 
   (Cod_Asig VARCHAR2(4), 
	Cod_Grupo NUMBER(2), 
	Tipo VARCHAR2(9) CONSTRAINT Tipo___es_Teoría_o_Prácticas CHECK (Tipo IN ('Teoría','Prácticas')), 
	Dia VARCHAR2(1) CONSTRAINT Dia_sem_in_L_M_X_J_V CHECK (Dia IN ('L','M','X','J','V')),
